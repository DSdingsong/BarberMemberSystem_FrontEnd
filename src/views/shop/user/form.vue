<template>
  <el-dialog :append-to-body="true" :close-on-click-modal="false" :before-close="cancel" :visible.sync="dialog" :title="isAdd ? '新增' : '编辑'" width="500px">
    <el-form ref="form" :model="form" :rules="rules" size="small" label-width="80px">
      ...
      <el-form-item label="会员余额" prop="nowMoney">
      ...
      <el-form-item label="会员折扣" prop="discount">
        <el-input-number v-model="form.discount"  :precision="1" :step="0.1" :max="10" controls-position="right" style="width: 145px;" />
      </el-form-item>
    ...
    return {
      ...
      rules: {
        ...
        phone: [
          ...
          { min: 6, max: 15, message: '请输入正确的手机号码', trigger: 'blur' }
        ],
        nowMoney: [
          { required: true, message: '请输入会员充值金额', trigger: 'blur' }
        ],
        level: [
